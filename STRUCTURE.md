# Estructura del Proyecto CachyOS Indigo
...
│   └── CachyOSIndigo.colors    # Archivo de colores principal
│
...
1. `color-schemes/CachyOSIndigo.colors`
2. `plasma/desktoptheme/CachyOS-Indigo-round/metadata.desktop`
3. `plasma/desktoptheme/CachyOS-Indigo-round/colors`
